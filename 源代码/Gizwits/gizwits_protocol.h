...
#define PH_MAX                           140
#define PH_LEN                           1
#define tempts_RATIO                         1
#define tempts_ADDITION                      0
#define tempts_MIN                           0
#define tempts_MAX                           100
#define tempts_LEN                           1
#define tds_ts_RATIO                         10
#define tds_ts_ADDITION                      0
#define tds_ts_MIN                           0
#define tds_ts_MAX                           50
#define tds_ts_LEN                           1
#define PH_L_RATIO                         1
#define PH_L_ADDITION                      0
#define PH_L_MIN                           0
#define PH_L_MAX                           5
#define PH_L_LEN                           1
#define PH_H_RATIO                         1
#define PH_H_ADDITION                      5
#define PH_H_MIN                           0
#define PH_H_MAX                           7
#define PH_H_LEN                           1
#define zhuodu_ts_RATIO                         10
#define zhuodu_ts_ADDITION                      0
#define zhuodu_ts_MIN                           0
#define zhuodu_ts_MAX                           100
#define zhuodu_ts_LEN                           1
...
#define shuiwen_MAX                           10000
#define shuiwen_LEN                           2
#define TDS_DAT_RATIO                         1
#define TDS_DAT_ADDITION                      0
#define TDS_DAT_MIN                           0
#define TDS_DAT_MAX                           10000
#define TDS_DAT_LEN                           2
...
typedef struct {
    float valuePH;
    uint32_t valuetempts;
    uint32_t valuetds_ts;
    uint32_t valuePH_L;
    uint32_t valuePH_H;
    uint32_t valuezhuodu_ts;
    uint32_t valuezhuodu;
    float valueshuiwen;
    uint32_t valueTDS_DAT;
} dataPoint_t;

/** User Area Device State Structure */
typedef struct {
    uint8_t flagPH:1;
    uint8_t flagtempts:1;
    uint8_t flagtds_ts:1;
    uint8_t flagPH_L:1;
    uint8_t flagPH_H:1;
    uint8_t flagzhuodu_ts:1;
    uint8_t flagzhuodu:1;
    uint8_t flagshuiwen:1;
    uint8_t flagTDS_DAT:1;
} dataPointFlags_t;
...
typedef struct {
    ...
    uint8_t valuePH_L;
    uint8_t valuePH_H;
    uint8_t valuezhuodu_ts;
    uint16_t valuezhuodu;
    uint16_t valueshuiwen;
    uint16_t valueTDS_DAT;
} devStatus_t;
